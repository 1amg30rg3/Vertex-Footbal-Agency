/**
 * ISO 3166-1 alpha-2 country codes with their E.164 dialling prefixes.
 *
 * Options are keyed by the ISO code rather than the prefix because prefixes are
 * not unique — +1 covers the US, Canada and much of the Caribbean, and +44
 * covers the UK, Guernsey, Jersey and the Isle of Man. Keying by prefix would
 * leave the select unable to show which entry is actually selected.
 */
const COUNTRIES = [
    ...
    ['EG', '+20'], ['ER', '+291'], ['ES', '+34'], ['ET', '+251'], ['FI', '+358'],
    ...
    ['IL', '+972'], ['IM', '+44'], ['IN', '+91'], ['IQ', '+964'], ['IR', '+98'],
    ...
    ['SV', '+503'], ['SX', '+1721'], ['SY', '+963'], ['SZ', '+268'], ['TC', '+1649'],
    ['TD', '+235'], ['TG', '+228'], ['TH', '+66'], ['TJ', '+992'], ['TK', '+690'],
    ['TL', '+670'], ['TM', '+993'], ['TN', '+216'], ['TO', '+676'], ['TR', '+90'],
    ['TT', '+1868'], ['TV', '+688'], ['TW', '+886'], ['TZ', '+255'], ['UA', '+380'],
    ['UG', '+256'], ['US', '+1'], ['UY', '+598'], ['UZ', '+998'], ['VA', '+39'],
    ['VC', '+1784'], ['VE', '+58'], ['VG', '+1284'], ['VI', '+1340'], ['VN', '+84'],
    ['VU', '+678'], ['WF', '+681'], ['WS', '+685'], ['YE', '+967'], ['YT', '+262'],
    ['ZA', '+27'], ['ZM', '+260'], ['ZW', '+263'],
];

export const DIAL_CODES = COUNTRIES.map(([iso, dial]) => ({ iso, dial }));

const DIAL_BY_ISO = Object.fromEntries(COUNTRIES);

/** Starting country for the language the visitor is reading in. */
...
export function defaultCountry(locale) {
    return COUNTRY_BY_LOCALE[locale] ?? 'GE';
}
